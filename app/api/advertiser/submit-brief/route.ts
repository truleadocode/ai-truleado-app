...
export async function POST(request: NextRequest) {
  try {
    ...
    // Trigger matching immediately (fire and forget)
    ...
    return NextResponse.json({ brief_id: brief.id, is_free: isFreeBrief })
  } catch (err) {
